    ...
    <section className="grid min-h-screen grid-cols-1 md:grid-cols-2 bg-black text-white">
        ...
        <div className="max-w-md w-full">
          ...
          <motion.div variants={primaryVariants} className="mb-10">
            <div className="space-y-3 text-neutral-400 text-sm leading-relaxed">
              <p>
                Waste X is a digital system for managing waste transfer, carrier
                verification, and compliance across construction workflows.
              </p>

              <p className="text-orange-500">System status: MVP deployment</p>

              <p>
                If you’ve landed here unintentionally or want to learn more,
                contact:
              </p>
      ...
      <div className="relative hidden md:block overflow-hidden group">
        ...
        >
          ...
          >
            A structured system for waste accountability across the UK
            construction sector.
          </motion.p>
